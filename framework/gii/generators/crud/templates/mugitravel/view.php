...
echo "\$this->breadcrumbs=array(
	...
	<section class="col-xs-12">
		...
		<?php echo "<?php echo CHtml::link('Tambah',\n\t array('create'),\n array('class' => 'btn btn-primary btn-flat','title'=>'Tambah $this->modelClass'));\n\t\t ?>\n"; ?>
		<?php echo "<?php echo CHtml::link('List',\n\t array('index'),\n array('class' => 'btn btn-primary btn-flat', 'title'=>'Daftar $this->modelClass'));\n\t\t ?>\n"; ?>
		<?php echo "<?php echo CHtml::link('Kelola',\n\t array('admin'),\n array('class' => 'btn btn-primary btn-flat','title'=>'Kelola $this->modelClass'));\n\t\t ?>\n"; ?>
