...
echo "\$this->breadcrumbs=array(
	...
	<section class="col-xs-12">
		...
		<?php echo "<?php echo CHtml::link('Add',\n\t array('create'),\n array('class' => 'btn btn-success','title'=>'Add $this->modelClass'));\n\t\t ?>\n"; ?>
		<?php echo "<?php echo CHtml::link('List',\n\t array('index'),\n array('class' => 'btn btn-success', 'title'=>'List $this->modelClass'));\n\t\t ?>\n"; ?>
		<?php echo "<?php echo CHtml::link('Manage',\n\t array('admin'),\n array('class' => 'btn btn-success','title'=>'Manage $this->modelClass'));\n\t\t ?>\n"; ?>
		<?php echo "<?php echo CHtml::link('Edit', \n\t array('update', 'id'=>\$model->{$this->tableSchema->primaryKey},\n\t\t), array('class' => 'btn btn-info', 'title'=>'Edit $this->modelClass'));\n ?>\n"; ?>
		<?php echo "<?php echo CHtml::link('Delete', \n\t array('delete', 'id'=>\$model->{$this->tableSchema->primaryKey},\n\t\t),  array('class' => 'btn btn-warning', 'title'=>'Hapus $this->modelClass'));\n ?>\n"; ?>
