...
echo "\$this->breadcrumbs=array(
	...
	<span class="hidden-xs">
		...
		<?php echo "<?php echo CHtml::link('Add $this->modelClass',\n array('create'),\n array('class' => 'md-btn md-btn-primary btn btn-primary btn-flat'));\n ?>\n"; ?>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<BR>
							<button type="button" class="md-btn md-btn-primary btn btn-default waves-effect" data-dismiss="modal">Close</button>
						</div>
					</div>
				</div>
			</div>
