...
class KepindahanController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow',
				'actions'=>array('view','kelola','daftar','view','desa','daftarverifikasi','terima','tolak','loadKecamatan','loadIdKota','loadKota','loadIdProvinsi','loadProvinsi','print','kabkota','kecamatan','loaddesa','report'),
				'users'=>array('@'),
