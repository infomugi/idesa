...
class Pekerjaan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('kd_pekerjaan, nama','required'),
			array('kd_pekerjaan, nama','unique'),
			array('kd_pekerjaan,', 'numerical', 'integerOnly'=>true),
			array('nama', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, kd_pekerjaan, nama', 'safe', 'on'=>'search'),
		);
	}
