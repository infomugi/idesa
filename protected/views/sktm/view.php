					...
					<?php echo CHtml::link('Hapus', 
						array('delete', 'id'=>$model->id_sktm,
							...
							<?php if($model->verifikasi_id==0){ ?>
								...
								<?php echo CHtml::link(CHtml::encode("Verifikasi Lapangan"), array('verifikasi', 'id'=>$model->id_sktm),array('class'=>'btn btn-success')); ?>

								<?php }else{ ?>
									<button class="btn btn-info disabled">Sudah di Verifikasi</button>
									<?php } ?>
																			...
																			<div class="col-md-4"> 
																				...
																				<?php $this->widget('zii.widgets.CDetailView', array(
																					...
																					'attributes'=>array(
																						array(
																							'name'=>'verifikasi_id',
																							'value'=>$model->verifikasi_id==0 ? "Belum di Verifikasi" : $model->VerifikasiPetugas->namalengkap
																							),

																						array(
																							'name'=>'verifikasi_tanggal',
																							'value'=>$model->verifikasi_tanggal,
																							'visible'=>$model->verifikasi_id!=0,
																							),

																						array(
																							'name'=>'verifikasi_keterangan',
																							'value'=>$model->verifikasi_keterangan,
																							'visible'=>$model->verifikasi_id!=0,
																							),
